...
import { Sandwich } from './sandwich.mjs';
...
import { Cracked } from './cracked.mjs';
...
import { Combiner } from './combiner.mjs';
...
class Generator {
    ...
    generateLevels() {
        ...
        this.game.addPlayer(players[0]);
        this.game.addPlayer(players[1]);
        this.game.addCombine(players[2]);

        this.game.addInput(new Input(players[0]));
        this.game.addInput(new Input(players[1], { left: 'arrowleft', right: 'arrowright', up: 'arrowup' }));

        this.game.addInput(new Input(players[2]));
        this.game.addInput(new Input(players[2], { left: 'arrowleft', right: 'arrowright', up: 'arrowup' }));
        ...
        this.game.addLevel(intro);
        this.game.addLevel(links);
        this.game.addLevel(belt);
        this.game.addLevel(push);
        this.game.addLevel(telly);
        this.game.addLevel(carry);
        this.game.addLevel(stair);
        this.game.addLevel(boss);
    }
}
