...
function generateLevels() {
    ...
    boss.addObject(new Ground({ x: 824, y: 440 }, { w: 160, h: 32 }, new Sandwich(ground, { w: 160, h: 32 })));
    ...
    boss.addObject(new Ground({ x: 1592, y: 440 }, { w: 160, h: 32 }, new Sandwich(ground, { w: 160, h: 32 })));
